...
insert into datasource.DataSource (dbname, bezeichnung, ip, username, password, iadmin, imail) values ('$1','$2','$3','$4','$5','$6','$7')
Create_Entry
}
...
if [ "$#" -ne 7 ]
then
    echo "Bitte setzen Sie folgende Argumente bei der Ausführung: 1. Name der Datenbank 2. Bezeichner der Datenbank 3. Ip der Datenbank 4. Name des Nutzers 5. Passwort des Nutzers 6. Name des Instanz Admins 7. Email des Instanz Admins"
        exit 1
else
