...
public class CommandCreateCreator extends CommandCreator {
  ...
  public static final String FILEEXTENSION = "create";

  public CommandCreateCreator() {
    super(FILEEXTENSION, TransformationUtils.CREATE_CMD);
  }
  ...
  protected List<ASTCDAttribute> createAttributes(ASTCDClass extendedClass, ASTCDClass domainClass,
    ...
    attr.getModifier().setStereotype(
            createJsonMemberStereotype(attr.getName(), typeName, true));
