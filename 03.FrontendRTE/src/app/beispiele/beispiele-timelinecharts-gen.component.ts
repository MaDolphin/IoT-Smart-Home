...
import { BeispieleTimelinechartsGenComponentTOP } from "@targetgui/beispiele-timelinecharts-gen.component/beispiele-timelinecharts-gen.component-top";

/**
 * See BeispielePieChartDTO.java, BeispielePieChartDTOLoader.java for more details on how to use PieCharts
 */
@Component({
  templateUrl: '../../../target/generated-sources/gui/beispiele-timelinecharts-gen.component/beispiele-timelinecharts-gen.component.html',
})
export class BeispieleTimelinechartsGenComponent extends BeispieleTimelinechartsGenComponentTOP implements OnInit {
