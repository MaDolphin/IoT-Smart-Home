...
import { ZahlenWertDTO } from '@shared/architecture/data/dtos/zahlenwert.dto';
...
export class ValidatorUtils {
  ...
  public static isPercentValid(zahlenWert: ZahlenWertDTO) {
        return zahlenWert.zahlenTyp === 'Prozent' && 0 <= zahlenWert.wert && zahlenWert.wert <= 10000;
    }
