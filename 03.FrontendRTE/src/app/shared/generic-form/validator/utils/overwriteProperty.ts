 ...
 *
 * @param ctx object whose property is to be overwritten
 * @param name of property to overwrite
 * @param getter function that returns a getter function to be used for name
 *
