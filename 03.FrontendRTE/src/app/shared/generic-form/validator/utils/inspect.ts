 ...
 * @return
 */
export function inspect(obj: any, showHidden?: boolean, depth?: number, colors?: boolean) {
  const ctx = {
    showHidden: showHidden,
    seen:       [],
    stylize:    function (str: string) {
      return str;
    },
  };
...
const isDOMElement = function (object: any) {
...
function formatValue(ctx: any, value: any, recurseTimes: number) {
