...
export function before(this: Assertion, date: string | Date | FormControl) {
  ...
  this.assert(controlDate.getTime() < date.getTime(), `date should be not before ${toDateString(date)}`);
