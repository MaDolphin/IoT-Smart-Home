...
var Logger = require('@upe/logger/dist/logger').Logger;
DC.disabled = true;
...
exports.config = {
  ...
  capabilities: {
    ...
    'chromeOptions': {
      ...
      args: ['--headless', '--disable-gpu', '--window-size=800x600','lang=de-DE',  '--allow-insecure-localhost'], //'--headless', '--disable-gpu', '--window-size=800x600',
